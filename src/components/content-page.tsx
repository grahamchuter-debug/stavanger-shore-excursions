...
export function ContentPage({
  ...
  breadcrumbs,
  belowHero,
  ctaTitle = "Explore Stavanger excursion options",
  ctaText = "Browse harbour walks and Lysefjord ideas shaped around a day in port, with enough margin to return before all aboard.",
  ctaHref = siteConfig.shoreExcursionsPath,
  ctaButtonLabel = "Explore Stavanger excursions",
  showShipReassurance = true,
  relatedSectionTitle = "Related Stavanger guides",
}: ContentPageProps) {
  const schema = [
    buildWebPageSchema({
      path: pagePath,
