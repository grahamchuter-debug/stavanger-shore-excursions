...
export function CruisePortDayPlanner({
  config = stavangerPortDayPlannerConfig,
                ...
                <dl className="grid grid-cols-1 gap-3 sm:grid-cols-3">
                  ...
                  <div>
                    ...
                    <dd className="mt-1 text-lg font-semibold text-[var(--norway-blue)]">
                      {result.returnGuidance.recommendedReturn ?? "TBC"}
                    </dd>
                  ...
                  <div>
                    ...
                    <dd className="mt-1 text-lg font-semibold text-slate-900">
                      {result.returnGuidance.latestComfortableReturn ?? "TBC"}
                    </dd>
